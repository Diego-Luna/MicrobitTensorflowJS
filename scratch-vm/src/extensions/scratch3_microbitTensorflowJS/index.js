...
async function trainModel() {
    const xs = tf.tensor2d(trainingData.map(item => [item.input]), [trainingData.length, 1]);
...
// const imgBLOC = "data:image/svg+xml;base64," // Add your icon base64 here
// const imgMenu = "data:image/svg+xml;base64," // Add your icon base64 here
...
class MicrobitTensorFlow {
    ...
    checkPrediction(args) {
        const classIndex = classNames.indexOf(args.CLASS);
        return classIndex === args.PREDICTION;
    }
}
